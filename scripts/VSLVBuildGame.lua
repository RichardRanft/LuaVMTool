...
DEBUG = true;
DEBUGCMD = false;
VMNAME = "vmware/OpenSUSE_12_2_32bit/OpenSUSE_12_2_32bit.vmx";
VMSTARTED = false;
ShareRoot = "/mnt/hgfs/"
...
function compile(Sandbox, GameCore, Game, Name)
    -- vm compile step
    local result = 0;
    if DEBUG == true then
...
function buildSLVGame(Path, Name, GameCore, Sandbox, VMName, Target)
    ...
    result = compile(Sandbox, GameCore, Name, Path);
