...
# Add your pre 'build' code here...
    #"$(shell sudo ln -s /usr/lib/vmware-vix/Workstation-10.0.0-and-vSphere-5.5.0/32bit/libgvmomi-vix-1.13.2.so.0 /usr/lib/vmware-vix/Workstation-10.0.0-and-vSphere-5.5.0/32bit/libgvmomi-vix-1.13.2.so)"
